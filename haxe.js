...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6313984,
    DYNAMIC_BASE = 11556864,
    DYNAMICTOP_PTR = 6313824;
...
// {{PRE_LIBRARY}}
  ...
  err('missing function: getgrgid'); abort(-1);
  }
  ...
  function _gethostbyaddr_r(
  ) {
  err('missing function: gethostbyaddr_r'); abort(-1);
  }
  ...
  var ___tm_current=6313840;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 6313888, 4), 6313888);function _gmtime_r(time, tmPtr) {
  ...
  function _re_partial_match(
  ) {
  err('missing function: re_partial_match'); abort(-1);
  }

  function _re_replacement_text(
  ) {
  err('missing function: re_replacement_text'); abort(-1);
  }

  function _re_search_backward(
  ) {
  err('missing function: re_search_backward'); abort(-1);
  }

  function _re_search_forward(
  ) {
  err('missing function: re_search_forward'); abort(-1);
  }

  function _re_string_match(
  ) {
  err('missing function: re_string_match'); abort(-1);
  }
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__handle_stack_overflow": ___handle_stack_overflow, "__lock": ___lock, "__map_file": ___map_file, "__syscall10": ___syscall10, "__syscall102": ___syscall102, "__syscall12": ___syscall12, "__syscall122": ___syscall122, "__syscall14": ___syscall14, "__syscall142": ___syscall142, "__syscall15": ___syscall15, "__syscall181": ___syscall181, "__syscall183": ___syscall183, "__syscall192": ___syscall192, "__syscall193": ___syscall193, "__syscall194": ___syscall194, "__syscall195": ___syscall195, "__syscall196": ___syscall196, "__syscall197": ___syscall197, "__syscall199": ___syscall199, "__syscall20": ___syscall20, "__syscall200": ___syscall200, "__syscall201": ___syscall201, "__syscall202": ___syscall202, "__syscall205": ___syscall205, "__syscall207": ___syscall207, "__syscall212": ___syscall212, "__syscall220": ___syscall220, "__syscall221": ___syscall221, "__syscall3": ___syscall3, "__syscall303": ___syscall303, "__syscall33": ___syscall33, "__syscall330": ___syscall330, "__syscall331": ___syscall331, "__syscall34": ___syscall34, "__syscall38": ___syscall38, "__syscall39": ___syscall39, "__syscall4": ___syscall4, "__syscall40": ___syscall40, "__syscall42": ___syscall42, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall60": ___syscall60, "__syscall63": ___syscall63, "__syscall64": ___syscall64, "__syscall66": ___syscall66, "__syscall77": ___syscall77, "__syscall83": ___syscall83, "__syscall85": ___syscall85, "__syscall9": ___syscall9, "__syscall91": ___syscall91, "__syscall94": ___syscall94, "__unlock": ___unlock, "abort": _abort, "alarm": _alarm, "chroot": _chroot, "clock_gettime": _clock_gettime, "dlclose": _dlclose, "dlerror": _dlerror, "dlopen": _dlopen, "dlsym": _dlsym, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_longjmp": _emscripten_longjmp, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "execv": _execv, "execve": _execve, "execvp": _execvp, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_sync": _fd_sync, "fd_write": _fd_write, "fork": _fork, "getTempRet0": _getTempRet0, "getaddrinfo": _getaddrinfo, "getgrgid": _getgrgid, "getgrnam": _getgrnam, "gethostbyaddr_r": _gethostbyaddr_r, "gethostbyname": _gethostbyname, "gethostbyname_r": _gethostbyname_r, "getitimer": _getitimer, "getnameinfo": _getnameinfo, "getprotobyname": _getprotobyname, "getprotobynumber": _getprotobynumber, "getpwnam": _getpwnam, "getpwuid": _getpwuid, "gettimeofday": _gettimeofday, "gmtime": _gmtime, "inet_addr": _inet_addr, "invoke_di": invoke_di, "invoke_ii": invoke_ii, "invoke_iii": invoke_iii, "invoke_iiii": invoke_iiii, "invoke_iiiii": invoke_iiiii, "invoke_iiiiii": invoke_iiiiii, "invoke_v": invoke_v, "invoke_vi": invoke_vi, "invoke_vid": invoke_vid, "invoke_vii": invoke_vii, "invoke_viii": invoke_viii, "invoke_viiii": invoke_viiii, "kill": _kill, "localtime": _localtime, "memory": wasmMemory, "mktime": _mktime, "nanosleep": _nanosleep, "pthread_attr_init": _pthread_attr_init, "pthread_attr_setdetachstate": _pthread_attr_setdetachstate, "pthread_cond_destroy": _pthread_cond_destroy, "pthread_cond_init": _pthread_cond_init, "pthread_create": _pthread_create, "pthread_exit": _pthread_exit, "pthread_join": _pthread_join, "pthread_sigmask": _pthread_sigmask, "re_partial_match": _re_partial_match, "re_replacement_text": _re_replacement_text, "re_search_backward": _re_search_backward, "re_search_forward": _re_search_forward, "re_string_match": _re_string_match, "round": _round, "saveSetjmp": _saveSetjmp, "setTempRet0": _setTempRet0, "setgroups": _setgroups, "setitimer": _setitimer, "shmat": _shmat, "sigaction": _sigaction, "sigaddset": _sigaddset, "sigdelset": _sigdelset, "sigemptyset": _sigemptyset, "sigfillset": _sigfillset, "sigismember": _sigismember, "siglongjmp": _siglongjmp, "sigpending": _sigpending, "sigprocmask": _sigprocmask, "sigsuspend": _sigsuspend, "sysconf": _sysconf, "system": _system, "table": wasmTable, "testSetjmp": _testSetjmp, "time": _time, "utimes": _utimes, "wait": _wait, "waitpid": _waitpid };
var asm = createWasm();
